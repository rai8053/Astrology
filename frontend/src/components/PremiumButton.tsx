...
export const PremiumButton = forwardRef<HTMLButtonElement, Props>(
  ({ className, variant = 'primary', size = 'md', loading, icon, children, magnetic = true, ...props }, ref) => (
    <motion.button
      ref={ref}
      ...
      className={`
        relative inline-flex items-center justify-center gap-2 font-sans font-bold uppercase tracking-[0.15em] overflow-hidden rounded-lg
