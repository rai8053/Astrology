        ...
        >
          <PremiumCard glass>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Input id="k_place" label="Birth Place" value={formData.birthPlace} onChange={(e) => { setFormData({ ...formData, birthPlace: e.target.value }); setErrors({ ...errors, birthPlace: '' }); }} required placeholder="City, Country" error={errors.birthPlace} />
