            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <BirthPlaceInput label={t('compatibility.place')} value={input.partnerA.birthPlace} onChange={(v) => setInput({ ...input, partnerA: { ...input.partnerA, birthPlace: v } })} required placeholder={t('compatibility.placePlaceholder')} state={input.partnerA.birthState} onStateChange={(v) => setInput({ ...input, partnerA: { ...input.partnerA, birthState: v } })} country={input.partnerA.birthCountry} onCountryChange={(v) => setInput({ ...input, partnerA: { ...input.partnerA, birthCountry: v } })} error={errors.partnerA?.birthPlace} />
                </div>
              </div>
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <BirthPlaceInput label={t('compatibility.place')} value={input.partnerB.birthPlace} onChange={(v) => setInput({ ...input, partnerB: { ...input.partnerB, birthPlace: v } })} required placeholder={t('compatibility.placePlaceholder')} state={input.partnerB.birthState} onStateChange={(v) => setInput({ ...input, partnerB: { ...input.partnerB, birthState: v } })} country={input.partnerB.birthCountry} onCountryChange={(v) => setInput({ ...input, partnerB: { ...input.partnerB, birthCountry: v } })} error={errors.partnerB?.birthPlace} />
                </div>
              </div>
